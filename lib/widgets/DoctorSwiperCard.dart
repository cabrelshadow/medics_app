...
import 'package:medics/Views/doctors/doctor_datail.dart';

import '../Views/doctors/TopDoctor.dart';
      ...
      * */
        child: Swiper(
            ...
            itemBuilder:(contex,index){
              return InkWell(
                onTap: (){
                  Get.to(()=>DoctorDetail(),transition: Transition.zoom,duration: 0.5.seconds);
                },
                child: Container(
                  width: 340.w,
                  height: 160.h,
